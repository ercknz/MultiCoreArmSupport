      ...
      /* Incoming Packet Structure: Header: [  0,  1,  2,  3,...
                        ...
                        goalQ4dot(rad/sec):   76, 77, 78, 79,...
                            ...
                            goalQ4dot(cts):  124,125,126,127,...
                                          :  128-129,...
                                RawFx(cts):  130,131,132,133,...
                                RawFy(cts):  134,135,136,137,...
                                RawFz(cts):  138,139,140,141,...
                                RawTx(cts):  142,143,144,145,...
                                RawTy(cts):  146,147,148,149,...
                                RawTz(cts):  150,151,152,153,...
                               GlobalFx(N):  154,155,156,157,...
                               GlobalFy(N):  158,159,160,161,...
                               GlobalFz(N):  162,163,164,165,...
                              GlobalTx(Nm):  166,167,168,169,...
                              GlobalTy(Nm):  170,171,172,173,...
                              GlobalTz(Nm):  174,175,176,177,...
                                 Modelx(m):  178,179,180,181,...
                                 Modely(m):  182,183,184,185,...
                                 Modelz(m):  186,187,188,189,...
                            Modelxdot(m/s):  190,191,192,193,...
                            Modelydot(m/s):  194,195,196,197,...
                            Modelzdot(m/s):  198,199,200,201,...
                            
                          currentDriveMode:  223,...
                                  loopTime:  224,225,226,227,...
                                  CheckSum:  228,229]
  */
